...
public class RabbitMQConfiguration
{
    ...
    public RabbitMQConfiguration(string hostName, string userName, string password, string clientId, TimeSpan retryDelay)
        : this(hostName: hostName, vhost: null, userName: userName, password: password, clientId, retryDelay) { }

    public RabbitMQConfiguration(string hostName, string vhost, string userName, string password, string clientId, TimeSpan retryDelay)
    {
        HostName = hostName;
        UserName = userName;
        Password = password;
